...
vn_util_diff |>
  filter(accum, discounted, fct_match(plan_type, c("pftdpw", "freq", "random", "none"))) |> 
  ggplot(aes(step)) +
  ...
  scale_color_discrete(
    "Planning Type", 
    labels = c("best" = "Best", "freq" = "Random (Frequentist)", "none" = "No Evaluation", "pftdpw" = "PFTDPW", random = "Random (Bayesian)"), 
...
```{r}
vn_util_diff |>
  filter(step == 1, accum, discounted, fct_match(plan_type, c("pftdpw", "freq"))) |> 
